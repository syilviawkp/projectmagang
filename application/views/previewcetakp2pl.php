...
<body>
  ...
  <div class="col-md-1">
   ...
   <div class="col-md-2">
    <br>
    <a href="<?php echo site_url('LaporanP2pl');?>"><button type="submit" style = "width: 150px" class="btn btn-outline-success"><span class="glyphicon glyphicon-arrow-left"></span>Back</button></a>
  </div>
